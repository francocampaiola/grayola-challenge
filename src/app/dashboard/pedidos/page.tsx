...
const Pedidos = () => {
  ...
  const filteredProjects = data?.filter((project) => {
    if (isDesigner) {
      return (
        ...
        project.project_designers?.some((pd) => pd.designer?.id === user?.id)
      );
    }
  ...
  return (
    <div className="p-4 w-full">
      <Table className="bg-gray-100 overflow-hidden w-full">
        <TableHeader>
                  ...
                  {project?.project_designers?.length ? (
                    <>
                      ...
                      {project.project_designers.filter(
                        ...
                        <span className="text-xs font-medium text-gray-600 ml-4 flex items-center">
                          +
                          {project.project_designers.filter(
                            (
                              pd
